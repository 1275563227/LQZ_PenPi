                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> 首页 <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="${pageContext.request.contextPath }/production/index.jsp"> Welcome </a></li>
                      <li><a href="https://www.jiguang.cn/dev/#/app/list#dev"> 极光推送链接 </a></li>
                      <li><a href="http://lbs.amap.com/dev/#/"> 高德地图链接 </a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-edit"></i> 推送 <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="${pageContext.request.contextPath }/production/form.jsp"> Push </a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-bar-chart-o"></i> 数据统计 <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="${pageContext.request.contextPath }/userAction_findAllUser"> Users Data </a></li>
                      <li><a href="${pageContext.request.contextPath }/orderAction_findAllOrder"> Orders Data </a></li>
                    </ul>
                  </li>
                </ul>
              </div>
