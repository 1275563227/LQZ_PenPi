            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-clone"></i> 地图 <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="${pageContext.request.contextPath }/production/images/img.jpg" alt="">瓶小盖
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="dashboard_graph">
                ...
                <div class="col-md-9 col-sm-9 col-xs-12">
                  <img alt="logo" src="${pageContext.request.contextPath }/production/images/logo.png" width="100%" height="300px">
                </div>
