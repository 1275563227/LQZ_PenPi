...
public class Wappay {
    ...
    public Wappay(Context mContext, Order order) {
        this.mContext = mContext;
        this.order = order;
        // 初始化BmobPay对象,可以在支付时再初始化
        BP.init("9677a5cfead71e12a204cbf60cd9e026");
    }
...
//                    installBmobPayPlugin("bp.db");
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    Toast.makeText(mContext, "您的手机上没有没有应用市场也没有浏览器，我也是醉了，你去想办法安装支付宝/微信吧", Toast.LENGTH_SHORT).show();
                }
            }
        }
        return false;
    ...
    double getPrice() {
        double price = 0.02;
        price = order.getCharges();
        return price;
    }

    // 商品详情(可不填)
    String getName() {
        return "订单号：" + order.getOrderID();
    }
