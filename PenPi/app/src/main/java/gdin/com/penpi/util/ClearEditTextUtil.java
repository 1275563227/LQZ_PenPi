 ...
 * 时间：2016.11.19
 */
public class ClearEditTextUtil extends EditText implements View.OnFocusChangeListener, TextWatcher {
    /**
     * 删除按钮的引用
     */
    ...
    public ClearEditTextUtil(Context context, AttributeSet attrs, int defStyle) {
