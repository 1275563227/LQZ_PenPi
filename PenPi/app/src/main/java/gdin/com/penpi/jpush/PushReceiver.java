...
//            String content = null;
//            Map map = JacksonUtils.readJson(bundle.getString(JPushInterface.EXTRA_EXTRA), Map.class);
//            if (map != null)
//                content = (String) map.get("content");
//            Log.d(TAG, "[PushReceiver] 接收到推送下来的通知的alert:   " + alert);
//            Log.d(TAG, "[PushReceiver] 接收到推送下来的通知的title:   " + title);
//            Log.d(TAG, "[PushReceiver] 接收到推送下来的通知的content: " + content);
//            NotificationUtil notiUtil = new NotificationUtil(context);
//            notiUtil.postNotification(alert, title, content);
            // ------------------------------------------------
